...
// STABILITY PATCH: Fix mobile height detachment
...
function renderHTMLLayout(htmlString) {
    ...
    if (!overlayLayer) {
        ...
        // FIX: Pulls it out of flow so buttons don't move or shrink
    ...
    let scale = 1; //
    if (videoEl && videoEl.offsetWidth > 0) {
        scale = videoEl.offsetWidth / 1920; //
    }
    
    overlayLayer.innerHTML = `
        <div class="layout-${mixerLayout}" style="width:1920px; height:1080px; transform-origin: top left; transform: scale(${scale}); pointer-events: none;">
            ${processedHTML}
        </div>
    `; //
...
// ======================================================
// 11. VIEWER CONNECTION & SIGNALLING
// ======================================================
...
// ======================================================
// 12. SOCKET & ROOM LOGIC (Detailed Verbatim)
// ======================================================
...
// ======================================================
// 13. HOST CONTROLS (Verbatim Detail)
// ======================================================
...
socket.on('public-chat', d => {
    ...
    // Re-render layout when public chat updates if overlay active
    if (overlayActive) {
        renderHTMLLayout(currentRawHTML); //
    }
});
...
// ======================================================
// 16. ARCADE & HTML OVERLAY (Legacy Update Listener)
// ======================================================
...
// ======================================================
// 17. USER LIST & MIXER SELECTION (FINAL VERBATIM)
// ======================================================
