...
// Host Extras
if ($('updateTitleBtn')) $('updateTitleBtn').addEventListener('click', () => { const t = $('streamTitleInput').value.trim(); if(t) socket.emit('update-title', t); });
if ($('updateSlugBtn')) $('updateSlugBtn').addEventListener('click', () => { const s = $('slugInput').value.trim(); if(s) updateLink(s); });
