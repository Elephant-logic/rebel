...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .emoji-bar span { transition: transform 0.2s; }
      ...
      .status-pill { margin-right: auto; background: #e50914; padding: 4px 10px; border-radius: 20px; font-weight: bold; font-size: 0.8rem; }

      @media(max-width: 600px) { .chat-overlay { width: 70%; left: 10px; bottom: 70px; height: 200px; } }
    </style>
  </head>
  <body>
    <div class="viewer-shell">
        ...
        <div id="chatBox" class="chat-overlay">
            ...
            <div class="chat-input-area">
                <div id="emojiStrip" class="emoji-bar">
                    <span class="emoji">😀</span><span class="emoji">😂</span><span class="emoji">😍</span><span class="emoji">🔥</span><span class="emoji">💀</span><span class="emoji">🤘</span><span class="emoji">❤️</span>
                </div>
                <div class="input-row">
                    <input id="chatInput" class="chat-input" placeholder="Chat..." />
        ...
        <div class="controls-bar">
            ...
            <button id="toggleChatBtn" class="btn-ctrl">Chat</button>
            <button id="unmuteBtn" class="btn-ctrl">🔇 Unmute</button>
            <button id="fullscreenBtn" class="btn-ctrl">⛶ Fullscreen</button>
        </div>
    </div>
